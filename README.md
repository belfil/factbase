...
(and (eq what 'issue-was-closed') (exists... -> 200                1.09
...
transaction rollback on factbase with 100000 facts                 0.16
...
(eq id (agg (always) (max id)))                                    2.89
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...                 4.52
(and (eq what "foo") (join "w<=what" (and (eq i...                 7.27
delete!                                                            0.51
(and (eq issue *) (eq repository *) (eq what '*') (eq where '*'))  0.43
Taped.append() x50000                                              0.02
Taped.each() x125                                                  1.54
Taped.delete_if() x375                                             0.83
50000 facts: read-only txn (no copy needed)                        7.62
50000 facts: rollback txn (no copy needed)                         7.29
50000 facts: insert in txn (copy triggered)                        3.46
50000 facts: modify in txn (copy triggered)                       37.99
100000 facts: read-only txn (no copy needed)                      16.82
100000 facts: rollback txn (no copy needed)                       16.67
100000 facts: insert in txn (copy triggered)                       8.01
100000 facts: modify in txn (copy triggered)                      73.63
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-01-30 at 19:33,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/belfil/factbase/actions/runs/21528040018
